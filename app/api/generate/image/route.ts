...
function responseStatus(code: string) {
  if (/INSUFFICIENT_CREDITS|FREE_ACCESS_RESTRICTED|FREE_IMAGE_TRIAL_EXHAUSTED|FREE_MEDIA_EXPIRED|PAID_PLAN_REACTIVATION_REQUIRED|PAID_MEDIA_ACCESS_REQUIRED|MODEL_TRIAL_EXHAUSTED/.test(code)) return 402;
