  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-[12%] left-[8%] h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,#1FD8B8_0%,transparent_70%)] opacity-18 blur-[100px] will-change-transform"
      />
