      ...
      <div className="p-7 md:p-9 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.06] pb-5">
          <div className="flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-[#FFFFFF]/10 border border-[#FFFFFF]/25">
              ...
              <AnimatePresence>
                {isDeducting && lastDeduction && (
                  <motion.span
                    ...
                    className="absolute -top-4 right-0 text-xs font-bold text-[#FFFFFF] font-mono"
                  >
                    -{lastDeduction}
                  </motion.span>
                )}
        ...
        >
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#FFFFFF]/25 bg-[#FFFFFF]/10 text-[#FFFFFF]">
          ...
          <div className="rounded-lg bg-black/40 p-3.5 border border-white/[0.03] space-y-2">
            <div className="flex items-center justify-between text-[11px] text-[rgba(245,246,248,0.4)] font-medium">
              ...
              <span className="text-[#FFFFFF] font-mono text-[10px]">
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-2.5 rounded-full bg-[#FFFFFF] h-12 text-sm font-bold text-[#050506] shadow-[0_4px_16px_rgba(31,216,184,0.25)] transition-all hover:bg-[#E5E7EB] disabled:opacity-60"
          >
            {isDeducting ? (
              <>
          ...
          {aiOutput && (
            <div className="rounded-xl border border-[#FFFFFF]/25 bg-black/60 p-4 space-y-2">
              <div
                className="flex items-center justify-between cursor-pointer text-xs font-semibold text-[#FFFFFF]"
        ...
        <div className="space-y-2">
          ...
          <div className="max-h-28 space-y-1.5 overflow-y-auto pr-1">
            {logs.map((log) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <ArrowDownRight className="h-3.5 w-3.5 text-[#FFFFFF]" />
