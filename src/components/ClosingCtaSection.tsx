...
export default function ClosingCtaSection() {
  ...
  return (
    <section className="py-24 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[#1FD8B8]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="rounded-3xl border border-white/[0.08] bg-[#0A0B0D]/90 p-8 sm:p-14 text-center space-y-8 shadow-[0_24px_60px_rgba(0,0,0,0.8)] backdrop-blur-2xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.035] px-4 py-1.5 text-xs font-medium text-[#1FD8B8]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            ...
            >
              ...
              <ArrowRight className="h-4 w-4 text-[#1FD8B8]" />
            </a>
          </div>
          ...
          <div className="border-t border-white/[0.06] pt-8 flex flex-wrap items-center justify-center gap-6 text-xs text-[rgba(245,246,248,0.6)]">
            <div className="flex items-center gap-2">
              <CreditCard className="h-4 w-4 text-[#1FD8B8]" />
