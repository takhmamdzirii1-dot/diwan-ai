...
export default function ShimmerButton({ text, onClick, className = '' }: ShimmerButtonProps) {
  return (
    ...
    >
      <span className="absolute inset-0 bg-gradient-to-r from-[#FFFFFF] via-[#8583FF] to-[#FFFFFF] bg-[length:200%_auto] animate-gradient" />
      <span className="relative flex h-full w-full items-center justify-center gap-2 rounded-full bg-[#FFFFFF] px-6 py-3 transition-colors hover:bg-[#E5E7EB]">
