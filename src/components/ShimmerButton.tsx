...
export default function ShimmerButton({ text, onClick, className = '' }: ShimmerButtonProps) {
  return (
    ...
    >
      <span className="absolute inset-0 bg-gradient-to-r from-[#E6C27A] via-[#8583FF] to-[#E6C27A] bg-[length:200%_auto] animate-gradient" />
      <span className="relative flex h-full w-full items-center justify-center gap-2 rounded-full bg-[#E6C27A] px-6 py-3 transition-colors hover:bg-[#F0DCAB]">
