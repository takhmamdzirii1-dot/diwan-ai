...
// Staggered motion container variants: exact 0.07s sibling stagger
...
export default function HeroSection() {
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 px-4 md:px-8 overflow-hidden">
      ...
      <HeroCinematicBackground speed={1.0} beamIntensity={1.25} />
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-7 text-left">
            ...
            <motion.div variants={itemVariants} className="inline-flex items-center">
              <div className="group relative flex items-center gap-2.5 rounded-full border border-white/[0.09] bg-white/[0.045] px-4 py-1.5 backdrop-blur-xl shadow-[0_0_20px_rgba(31,216,184,0.12)] transition-all duration-[250ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-[#1FD8B8]/40">
                ...
                <span className="text-xs md:text-sm font-semibold text-[#F5F6F8]">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#F5F6F8] leading-[1.15]"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-base sm:text-lg text-[rgba(245,246,248,0.6)] max-w-2xl leading-relaxed font-sans"
            >
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                href="#cost-table"
                className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-white/[0.09] bg-white/[0.045] px-6 py-3 text-sm font-semibold text-[#F5F6F8] backdrop-blur-xl transition-all duration-[250ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-white/[0.08] hover:border-white/[0.18]"
              >
                <Layers className="h-4 w-4 text-[#1FD8B8]" />
                <span>Explore Cost Table</span>
                <ArrowRight className="h-4 w-4 text-[rgba(245,246,248,0.45)]" />
              </motion.a>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-3 pt-2">
              <motion.div
                ...
                className="flex items-center gap-2 rounded-full border border-white/[0.09] bg-white/[0.045] px-4 py-2 backdrop-blur-xl shadow-sm"
              >
                <MessageSquare className="h-4 w-4 text-[#1FD8B8]" />
                <span className="text-xs font-semibold text-[#F5F6F8]">Claude 3.5 Sonnet</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs font-semibold text-[#F5F6F8]">Flux.1 Pro</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-xs font-semibold text-[#F5F6F8]">Kling AI 1.5 HD</span>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <Zap className="h-4 w-4 text-[#1FD8B8]" />
            ...
            <motion.div
              variants={itemVariants}
              className="grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-white/[0.09] pt-6"
            >
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-[#F5F6F8] font-mono">12+</div>
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-[#F5F6F8] font-mono">0s</div>
