            ...
            return (
              <SpotlightCard key={idx} className="p-8 space-y-5">
                <div className="flex items-center justify-between">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#FFFFFF]/10 border border-[#FFFFFF]/20 text-[#FFFFFF]">
                    <Icon className="h-6 w-6" />
                  </div>
                  <span className="rounded-full bg-white/[0.04] border border-white/[0.06] px-3 py-1 text-[11px] font-semibold text-[#FFFFFF]">
                    {feat.badge}
                  </span>
                </div>
                ...
                <div className="pt-2 border-t border-white/[0.06] flex items-center gap-2 text-xs text-[#FFFFFF] font-medium">
