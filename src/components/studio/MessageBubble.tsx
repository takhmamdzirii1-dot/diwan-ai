  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="text-[15px] leading-relaxed w-full" dir="auto">
          {(!isUser && isLatest && isStreaming) ? (
            ...
            <div className="prose prose-invert prose-p:leading-relaxed prose-pre:bg-[#0A0B0D] prose-pre:border-white/10 max-w-none">
              <ReactMarkdown
