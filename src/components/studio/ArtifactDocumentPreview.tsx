...
export default function ArtifactDocumentPreview({ artifact, locale, onClose }: { artifact: DocumentArtifact; locale: string; onClose: () => void }) {
  ...
  return <div role="dialog" aria-modal="true" aria-label={artifact.title} className="fixed inset-0 z-[100] overflow-y-auto bg-black/90 p-3 sm:p-8 print:static print:bg-white print:p-0" dir={artifact.direction}>
    <div className="mx-auto max-w-4xl">
      ...
      <article lang={artifact.language} dir={artifact.direction} className="min-h-[70vh] rounded-xl bg-white px-7 py-10 text-neutral-900 shadow-2xl sm:px-14 print:min-h-0 print:rounded-none print:p-0 print:shadow-none">
