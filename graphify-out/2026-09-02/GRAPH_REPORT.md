...
## Summary
- 646 nodes · 840 edges · 137 communities (85 shown, 52 thin omitted)
...
### Community 1 - "SettingsModal.tsx"
Cohesion: 0.08
Nodes (22): CategoryType, LEDGER_MODELS, LiveLedgerCard(), LiveLedgerCardProps, LogItem, ModelInfo, BillingPanel(), IMAGE_MODEL_HINTS (+14 more)
...
Cohesion: 0.08
Nodes (21): cairo, ibmPlexMono, inter, metadata, AmbientMotionBackground(), AmbientMotionBackgroundProps, AuthModal(), AuthModalProps (+13 more)

### Community 10 - "HeroSection.tsx"
Cohesion: 0.20
Nodes (6): HeroCinematicBackgroundProps, hashSeed(), HeroSection(), HeroSectionProps, PATHS, STATS
...
Cohesion: 0.24
Nodes (6): CinematicScrollMockup(), FEATURES, GlobalFooter(), LINKS, ADVANTAGES, WhyVantra()
...
### Community 28 - "ui.tsx"
Cohesion: 0.28
Nodes (6): FinalCta(), HowItWorks(), STEPS, Magnetic(), SectionHeading(), SpotlightCard()
...
### Community 69 - "components/ui/logo-cloud-3.tsx"
Cohesion: 0.33
...
### Community 85 - "TerminalShowcase.tsx"
Cohesion: 0.40
...
### Community 132 - "GlobalPricing.tsx"
Cohesion: 0.40
Nodes (4): GlobalPricing(), PricingTier, SHARED_PRODUCT_BENEFITS, TIERS

### Community 134 - "Faq.tsx"
Cohesion: 0.40
Nodes (4): Faq(), FAQ_OWNER_TODOS, FaqItem, FAQS

### Community 135 - "Testimonials.tsx"
Cohesion: 0.40
Nodes (3): Testimonial, TESTIMONIAL_ROWS, Testimonials()

## Knowledge Gaps
- **255 isolated node(s):** `Logo`, `LogoCloudProps`, `AuthModalProps`, `LINKS`, `HeroSectionProps` (+250 more)
...
- **Why does `cn()` connect `cn` to `SettingsModal.tsx`, `StudioDashboard`, `GlobalPricing.tsx`, `components/ui/logo-cloud-3.tsx`, `Faq.tsx`, `MotionStudio.tsx`, `ImageConfigPopover.tsx`, `ui.tsx`, `MediaLibrary.tsx`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `createClient()` connect `generate-image/route.ts` to `MotionStudio.tsx`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `useUser()` connect `SettingsModal.tsx` to `StudioDashboard`, `MotionStudio.tsx`, `cn`, `src/context/ModalContext.tsx`, `App.tsx`, `src/components/OriginalLandingPage.tsx`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `Logo`, `LogoCloudProps`, `AuthModalProps` to the rest of the system?**
