...
## Summary
- 780 nodes · 1020 edges · 144 communities (92 shown, 52 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a53879c1`
...
### Community 5 - "LandingHeader.tsx"
Cohesion: 0.24
Nodes (7): GlobalFooter(), LINKS, LandingHeader(), LandingHeaderProps, LOCALES, NAV_LINKS, VantraLogo()
...
### Community 22 - "src/components/OriginalLandingPage.tsx"
Cohesion: 0.28
Nodes (5): CinematicScrollMockup(), FEATURE_IMAGES, CinematicEnter(), HowItWorks(), STEP_ICONS
...
### Community 40 - "components/ui/logo-cloud-3.tsx"
Cohesion: 0.33
...
Cohesion: 0.16
Nodes (11): GhostButton(), PanelLabel(), ScrollArea, SHELL_TOKENS, StateBlock(), WorkspaceShell(), CREATE_ITEMS, DashboardSidebarProps (+3 more)
...
Cohesion: 0.14
Nodes (13): DashboardSidebar(), ProfilePanel(), CenterMode, ChatSession, MAGIC_SKILLS, ConnectionsPanel(), CreditsPanel(), GeneralPanel() (+5 more)

### Community 118 - "ui.tsx"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (24): PrimaryButton(), Segmented(), ASPECT_RATIOS, ImageCanvas(), ImageRequestDraft, OUTPUT_COUNTS, ASPECT_RATIOS, CAMERA_PRESETS (+16 more)
...
## Knowledge Gaps
- **326 isolated node(s):** `ASPECT_RATIOS`, `OUTPUT_COUNTS`, `ImageRequestDraft`, `DURATIONS`, `ASPECT_RATIOS` (+321 more)
...
- **Why does `cn()` connect `cn` to `[locale]/layout.tsx`, `claude-style-chat-input.tsx`, `LandingHeader.tsx`, `MotionStudio.tsx`, `components/ui/logo-cloud-3.tsx`, `MessageBubble.tsx`, `StudioDashboard`, `VideoConfigPopover.tsx`, `DashboardSidebar.tsx`, `ImageConfigPopover.tsx`, `ui.tsx`, `MediaLibrary.tsx`, `StudioDashboard.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `getModelCost()` connect `generate-image/route.ts` to `src/context/ModalContext.tsx`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **What connects `ASPECT_RATIOS`, `OUTPUT_COUNTS`, `ImageRequestDraft` to the rest of the system?**
