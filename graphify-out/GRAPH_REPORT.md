...
## Summary
- 753 nodes · 977 edges · 147 communities (95 shown, 52 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `108fd7c3`
...
Cohesion: 0.07
Nodes (21): BillingPanel(), IMAGE_MODEL_HINTS, IMAGE_MODELS, INSTRUCTION_SUGGESTIONS, PrivacyPanel(), ProfilePanel(), ProviderConnections(), TabId (+13 more)

### Community 9 - "src/context/ModalContext.tsx"
Cohesion: 0.07
Nodes (25): cairo, ibmPlexMono, inter, rootFontClasses, metadata, metadata, AmbientMotionBackground(), AmbientMotionBackgroundProps (+17 more)
...
### Community 23 - "ui.tsx"
Cohesion: 0.19
Nodes (9): Faq(), FAQ_OWNER_TODOS, FaqItem, FinalCta(), HowItWorks(), STEP_ICONS, Magnetic(), SectionHeading() (+1 more)
...
Cohesion: 0.10
Nodes (19): MarketingLocaleLayout(), dynamic, dynamicParams, generateMetadata(), languageAlternates, loadMessages(), messageLoaders, { Link, redirect, usePathname, useRouter, getPathname } (+11 more)
...
Cohesion: 0.13
Nodes (16): LandingHeader(), LandingHeaderProps, LOCALES, NAV_LINKS, CREATE_ITEMS, DashboardSidebar(), DashboardSidebarProps, SidebarSession (+8 more)
...
Cohesion: 0.27
Nodes (5): CinematicScrollMockup(), FEATURE_IMAGES, GlobalFooter(), LINKS, CinematicEnter()
...
### Community 135 - "ImageCanvas.tsx"
Cohesion: 0.33
Nodes (4): LiquidMetalButton(), LiquidMetalButtonProps, PROVIDER_REGISTRY, ImageCanvas()

### Community 137 - "components/ui/logo-cloud-3.tsx"
Cohesion: 0.33
Nodes (5): Logo, LogoCloud(), LogoCloudProps, logos, PartnersSection()

### Community 138 - "HeroSection.tsx"
Cohesion: 0.40
Nodes (5): hashSeed(), HeroSection(), HeroSectionProps, PATHS, HERO_STAT_VALUES

### Community 139 - "TerminalShowcase.tsx"
Cohesion: 0.40
Nodes (5): cn2(), Line, SCRIPT, TerminalShowcase(), TONE_CLASS

## Knowledge Gaps
- **312 isolated node(s):** `metadata`, `languageAlternates`, `dynamicParams`, `dynamic`, `metadata` (+307 more)
...
- **Why does `cn()` connect `cn` to `[locale]/page.tsx`, `claude-style-chat-input.tsx`, `StudioDashboard.tsx`, `ImageCanvas.tsx`, `MessageBubble.tsx`, `components/ui/logo-cloud-3.tsx`, `SettingsModal.tsx`, `ImageConfigPopover.tsx`, `lib/utils.ts`, `ui.tsx`, `MotionStudio.tsx`, `MediaLibrary.tsx`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `useUser()` connect `SettingsModal.tsx` to `src/components/LiveLedgerCard.tsx`, `[locale]/page.tsx`, `StudioDashboard.tsx`, `src/context/ModalContext.tsx`, `src/components/OriginalLandingPage.tsx`?**
